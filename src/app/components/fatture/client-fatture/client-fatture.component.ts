...
export class ClientFattureComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'data', 'numero', 'anno', 'importo', 'stato', 'ragioneSociale', 'dettaglioFattura', 'eliminaFattura'];
  items!:any;
  pageNumber:number = 0;
  fatture!:any;
  clientId!:number;
  ...
  dataSource!:any;
  constructor(private fattureSrv:FattureService, private route:ActivatedRoute, private location: Location ) { }
